...
abstract class Package_Markdown_XHTML extends Package_PHP_XHTML {
    private $myelementmap = array(
        ...
        'title'                 => array(
            ...
            'formalpara'        => 'format_h5',
            'legalnotice'       => 'format_h4',
            'note'              => 'format_note_title',
            'phd:toc'           => 'strong',
            'refsect1'          => 'format_h3',
            'refsect2'          => 'format_h4',
...
return $value;
    ...
    public function format_acronym_text($value, $tag) {
        /* MARKDOWN: PUSH DEFINITION TO END OF FILE */
    ...
    function format_h1($open) {
        if ($open) {
            return "#";
        }
    }
    function format_h2($open) {
        if ($open) {
            return "##";
        }
    }
    function format_h3($open) {
        if ($open) {
            return "###";
        }
    }
